...
import { Plus, Filter, Trash2, Check, X } from 'lucide-react';
...
const Transactions: React.FC = () => {
  ...
  // Enhanced status color function with more distinct colors
  const getEnhancedStatusColor = (status: string): string => {
    switch (status.toLowerCase()) {
      ...
      case 'in transit':
        return 'bg-purple-900/80 backdrop-blur-sm text-purple-300 border border-purple-600/50';
      case 'collected':
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-1">Track and manage all your FBA transactions</p>
          </div>
          <button 
  ...
  const statuses = ['Ordered', 'In Transit', 'Collected', 'Partially Received', 'Fully Received'];
